...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit" class="space-y-8">
            <!-- Email Field -->
            <div class="group">
                <label for="email" class="block text-sm font-semibold text-gray-800 mb-3 transition-colors group-focus-within:text-blue-600">
                    {{ t('email') }}
                </label>
                <div class="relative">
                    ...
                    <input
                        ...
                        type="email"
                        :placeholder="t('email')"
                        class="w-full pl-12 rtl:pl-4 rtl:pr-12 pr-4 py-4 text-gray-900 bg-gray-50 border-0 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md focus:shadow-lg"
